function CodeDefine() { 
this.def = new Array();
this.def["__attribute__"] = {file: "LEDBlinking_main_c.html",line:29,type:"fcn"};
this.def["main"] = {file: "LEDBlinking_main_c.html",line:101,type:"fcn"};
this.def["rtDW"] = {file: "LEDBlinking_c.html",line:21,type:"var"};
this.def["rtM_"] = {file: "LEDBlinking_c.html",line:24,type:"var"};
this.def["rtM"] = {file: "LEDBlinking_c.html",line:25,type:"var"};
this.def["LEDBlinking_step0"] = {file: "LEDBlinking_c.html",line:28,type:"fcn"};
this.def["LEDBlinking_step1"] = {file: "LEDBlinking_c.html",line:34,type:"fcn"};
this.def["LEDBlinking_initialize"] = {file: "LEDBlinking_c.html",line:70,type:"fcn"};
this.def["RT_MODEL"] = {file: "LEDBlinking_h.html",line:49,type:"type"};
this.def["DW"] = {file: "LEDBlinking_h.html",line:54,type:"type"};
...
function Html2SrcLink() {
	...
	this.html2SrcPath["LEDBlinking_main_c.html"] = "../LEDBlinking_main.c";
	this.html2Root["LEDBlinking_main_c.html"] = "LEDBlinking_main_c.html";
	this.html2SrcPath["LEDBlinking_c.html"] = "../LEDBlinking.c";
	this.html2Root["LEDBlinking_c.html"] = "LEDBlinking_c.html";
	this.html2SrcPath["LEDBlinking_h.html"] = "../LEDBlinking.h";
	this.html2Root["LEDBlinking_h.html"] = "LEDBlinking_h.html";
...
var fileList = [
"LEDBlinking_main_c.html","LEDBlinking_c.html","LEDBlinking_h.html","rtwtypes_h.html","rtmodel_h.html"];
