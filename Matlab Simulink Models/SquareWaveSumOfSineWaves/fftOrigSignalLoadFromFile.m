...
orig_signal.orig_signal.plot

%%
dt=orig_signal.orig_signal.Time(2)-orig_signal.orig_signal.Time(1);
length = orig_signal.orig_signal.Length;
time=orig_signal.orig_signal.Time;
data=orig_signal.orig_signal.Data;
